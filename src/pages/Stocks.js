    ...
    <>
    {
        !flag ? (
            ...
            <div className="stock-column-data">
                ...
                summary ? (
                    <>
                        <h2><span style={{ color: "black" }}><span className='summary-span'>{summary.exchangeName} ({summary.symbol})
                            </span> ${summary.regularMarketPrice}</span></h2>
                        <div className="stock-headings">
                        <h4><span className='summary-span'>Exchange Name:</span><span style={{color: "black"}}>{""}{summary.exchangeName} 
                            </span></h4>
                        <hr /><br />
                        <h4><span className='summary-span'>Instrument Type:</span><span style={{color: "black"}}>{""}{summary.instrumentType} 
                            </span></h4>
                        <hr /><br />
                        <h4><span className='summary-span'>Previous Close Price:</span><span style={{color: "black"}}>{""}{summary.chartPreviousClose} 
                            </span></h4>
                        <hr /><br />
                        <h4><span className='summary-span'>Current Price:</span><span style={{color: "black"}}>{""}{summary.regularMarketPrice} 
                            </span></h4>
                        <hr /><br />
                    </div>
                </>
